...
public class KoshiraeModifier extends NoLevelsModifier{
    public static CompoundTag serializeNBT(LazyOptional<ISlashBladeState> state){
    ...
    public static void deserializeNBT(LazyOptional<ISlashBladeState> state, CompoundTag nbt){
        Tag baseTag;
